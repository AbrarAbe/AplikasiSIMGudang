...
<body>
  <nav class="navbar navbar-expand-sm">
    <div class="col-md-7">
      <div class="container-fluid">
        <div class="navbar-brand1">
          <div class="col-md-2">
            <img src="assets/images/warehouse2.gif" width="100%" height="100%">
          </div>
    ...
    <div class="col-md-3">
      <div class="collapse navbar-collapse margin-right" id="collapsibleNavbar">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="umum.php">Beranda</a>
          </li>
  ...
  <div class="d-flex align-items-center justify-content-center login-container">
    <iframe src="menu_umum.php" name="frmmenu" width="100%" height="700vh"></iframe>
  </div>
